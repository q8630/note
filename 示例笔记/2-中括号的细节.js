...
console.log(reg.test('125'));//=>false 不是12~65
console.log(reg.test('135'));//=>false 不是12~65
console.log(reg.test('145'));//=>false 不是12~65
console.log(reg.test('165'));//=>false 不是12~65
