...
$(function(){
    ...
    (function(){
        ...
        function doFade(action){
            ...
            aContents.eq(nowIndex).find("h1, p, imgs").attr("class","").addClass("animated "+action);
        }
    })();


    /*公司简介只有一页时，让所有的切换点击不可用*/
    $(".chanpin .now_line, .chanpin .change_line span").css("opacity",'0');
